            ...
            <div key={item.id}>
              {item.hasSubmenu ? (
                  ...
                  <CollapsibleContent className="ml-6 mt-1 space-y-1">
                    {item.submenu?.map(subItem => (
                      <Button 
                        ...
                        className={cn("w-full justify-start text-sm", activeItem === subItem.id && "bg-blue-600 text-white hover:bg-blue-700")} 
                ...
                <Button 
                  ...
                  className={cn("w-full justify-start", activeItem === item.id && "bg-blue-600 text-white hover:bg-blue-700")} 
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500 truncate">
              {user?.email || 'admin@sarkari.ninja'}
            </p>
          </div>
        </div>
        <Button 
